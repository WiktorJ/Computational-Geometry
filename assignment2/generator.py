...
write_tuple_to_file("data_set_3.csv", generate_on_quadrangle((-10, 10), (-10, -10), (10, -10), (10, 10), 100))
write_tuple_to_file("data_set_4.csv", generate_on_square((0, 10), (0, 0), (10, 0), (10, 10), 20, 25))